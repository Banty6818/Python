...
class PuzzleState:
    ...
    def a_star(start_state, target_state):
        ...
        while open_list:
            ...
            for child in PuzzleState.get_children(current_state):
                if child in closed_list:
                    continue
                
                child.cost += PuzzleState.heuristic(child.state, target_state)
...
path = PuzzleState.a_star(start_node, target_state)
